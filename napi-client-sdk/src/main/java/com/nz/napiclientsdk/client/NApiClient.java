package com.nz.napiclientsdk.client;
...
import static com.nz.napiclientsdk.utils.SignUtils.genSign;


/**
 * 调用第三方接口的客户端
 */
public class NApiClient {
    ...
    public NApiClient(String accessKey, String secretKey) {
