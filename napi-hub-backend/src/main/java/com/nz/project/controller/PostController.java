...
import com.nz.project.common.BaseResponse;
import com.nz.project.common.DeleteRequest;
import com.nz.project.common.ErrorCode;
import com.nz.project.common.ResultUtils;
import com.nz.project.constant.CommonConstant;
import com.nz.project.exception.BusinessException;
import com.nz.project.model.dto.post.PostAddRequest;
import com.nz.project.model.dto.post.PostQueryRequest;
import com.nz.project.model.dto.post.PostUpdateRequest;
 ...
 * 帖子接口
 *
 * @author <a href="https://github.com/linz">程序员鱼皮</a>
 * @from <a href="https://nz.icu">编程导航知识星球</a>
 */
@RestController
@RequestMapping("/post")
@Slf4j
