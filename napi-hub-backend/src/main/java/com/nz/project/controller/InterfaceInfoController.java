...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        NApiClient tempClient = new NApiClient(accessKey, secretKey);
        Gson gson = new Gson();
        com.nz.napiclientsdk.model.User user = gson.fromJson(userRequestParams, com.nz.napiclientsdk.model.User.class);
